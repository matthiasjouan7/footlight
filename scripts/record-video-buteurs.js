...
// base) qui enchaîne plusieurs profils joueurs — pensé pour du contenu
// "buteurs de la journée" (réseaux sociaux, format Reel) plutôt qu'un seul
// profil. Prend une liste de noms, les résout en joueur_id, puis filme
// chaque profil avec l'historique de matchs déroulé (badge "vérifié FFF").
//
...
for (const j of joueurs) {
  ...
  // Pause sur le haut du profil (identité, club) puis scroll jusqu'à
  // l'historique des matchs (buts, badge "vérifié FFF").
  await page.waitForTimeout(1500);
