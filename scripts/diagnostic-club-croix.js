// Diagnostic lecture seule : trouve le nom exact du club Iris Club de
// Croix dans calendrier_officiel (National 2, saison 2026-2027), avant de
...
const candidats = [...noms].filter((n) => (n || '').toLowerCase().includes('croix'));
console.log(`Candidat(s) contenant "croix" : ${candidats.length}`);
...
console.log(`\nJoueur(s) déjà en base avec club contenant "croix" : ${joueurs?.length || 0}`);
