...
// canonique de cette même logique) : pour ~12 clubs distincts, le nom
// officiel porte un qualificatif (acronyme, région, département) que
...
function clubWords(s) {
  ...
  // plus haut (suffixe d'équipe réserve "1"/"2") ; généralise l'ancien cas
  // particulier "hyeres" -> retire "83" à tout nombre de 1-3 chiffres isolé.
