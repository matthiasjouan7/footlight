...
// Saint-Quentin dans calendrier_officiel (National 2, saison 2026-2027),
// avant de créer le script d'ajout d'effectif.
...
const candidats = [...noms].filter((n) => (n || '').toLowerCase().includes('quentin'));
console.log(`Candidat(s) contenant "quentin" : ${candidats.length}`);
...
console.log(`\nJoueur(s) déjà en base avec club contenant "quentin" : ${joueurs?.length || 0}`);
