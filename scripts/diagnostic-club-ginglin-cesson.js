...
// calendrier_officiel pour l'équipe AS Ginglin Cesson (National 2), avant
...
const { data, error } = await supabase
  ...
  .eq('division', 'N2')
  .eq('saison', '2026-2027')
  .or('equipe_domicile.ilike.%ginglin%,equipe_exterieur.ilike.%ginglin%,equipe_domicile.ilike.%cesson%,equipe_exterieur.ilike.%cesson%');
