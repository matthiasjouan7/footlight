// Diagnostic lecture seule : trouve le nom exact du club IS-Selongey
// Football dans calendrier_officiel (National 2, saison 2026-2027), avant
...
const candidats = [...noms].filter((n) => (n || '').toLowerCase().includes('selongey'));
console.log(`Candidat(s) contenant "selongey" : ${candidats.length}`);
...
console.log(`\nJoueur(s) déjà en base avec club contenant "selongey" : ${joueurs?.length || 0}`);
