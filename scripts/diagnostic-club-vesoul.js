// Diagnostic lecture seule : trouve le nom exact du club Football Club de
// Vesoul dans calendrier_officiel (National 2, saison 2026-2027), avant de
...
const candidats = [...noms].filter((n) => (n || '').toLowerCase().includes('vesoul'));
console.log(`Candidat(s) contenant "vesoul" : ${candidats.length}`);
...
console.log(`\nJoueur(s) déjà en base avec club contenant "vesoul" : ${joueurs?.length || 0}`);
