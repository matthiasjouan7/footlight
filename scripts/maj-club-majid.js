// Met à jour le club d'Ahmed Majid vers "AS Cannes" (confirmé par
// l'utilisateur — transfert détecté lors de l'ajout de l'effectif AS
// Cannes, ajouter-effectif-cannes.js).
//
...
const NOUVEAU_CLUB = 'AS Cannes';
const ID = '53ee77f0-aeaa-4e77-a8b0-8e4e4cba7335'; // Ahmed Majid
