// Diagnostic lecture seule : trouve le nom exact du club Jeanne d'Arc de
// Drancy dans calendrier_officiel (National 2, saison 2026-2027), avant de
...
const candidats = [...noms].filter((n) => (n || '').toLowerCase().includes('drancy'));
console.log(`Candidat(s) contenant "drancy" : ${candidats.length}`);
...
console.log(`\nJoueur(s) déjà en base avec club contenant "drancy" : ${joueurs?.length || 0}`);
