// Diagnostic lecture seule : trouve le nom exact du club AS Saint-Ouen-
// l'Aumône dans calendrier_officiel (National 2, saison 2026-2027), avant
...
const candidats = [...noms].filter((n) => (n || '').toLowerCase().includes('ouen'));
console.log(`Candidat(s) contenant "ouen" : ${candidats.length}`);
...
console.log(`\nJoueur(s) déjà en base avec club contenant "ouen" : ${joueurs?.length || 0}`);
