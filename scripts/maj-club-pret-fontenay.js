// Met à jour le club de Stany Epagna, prêté à Vendée Fontenay Foot
// (National 2, saison 2026-2027) : présent dans la capture d'écran de
// l'effectif avec une icône de prêt, déjà en base sous
// club="Olympique Saumur" (identifié via ajouter-effectif-fontenay.js).
...
const NOUVEAU_CLUB = 'Vendée Fontenay Foot';
const ID = '6684d0b1-3234-4202-a8e4-96dca8fa416d'; // Stany Epagna
