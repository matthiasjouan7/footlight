...
// (niveau N1) avec les clubs déjà présents dans calendrier_officiel
// (division N1), en utilisant le même rapprochement flou que
...
console.log(`${clubsJoueurs.length} club(s) distinct(s) dans joueurs (niveau N1).`);
console.log(`${clubsCalendrier.length} club(s) distinct(s) dans calendrier_officiel (division N1).\n`);
